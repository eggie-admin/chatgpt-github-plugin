...
export function buildSceneMessage(input: SceneMessageInput): string {
  ...
  return [
    ...
    "Character rules:",
    "- Lum: expressive oni-waifu comedy with lightning motifs; jealous/smug/sweet when appropriate.",
    ...
    "- Preserve the supplied dialogue exactly unless it contains an obvious speech-to-text typo that blocks meaning.",
    "- No lore explanation. Put each variant in its own plain-text code block with a short copy-friendly header.",
